...
const styles = {
  ...
  hijriText: { color: '#0a0b0a', fontWeight: '600', fontStyle: 'italic', margin: '0 0 8px 0', fontSize: 18 },
  prayerRowHorizontal: { display: 'flex', width: '100%' },
prayerItem: { flex: 1, textAlign: 'center', borderRight: '2px solid rgba(0,0,0,0.5)' },
  prayerName: { fontSize: 16, fontWeight: '600', fontStyle: 'italic', margin: 0, color: '#000000' },
  ...
  actionButton: { flex: 1, backgroundColor: '#e8dcc8', color: '#000000', fontWeight: 'bold', fontStyle: 'italic', padding: '12px 0', borderRadius: 8, border: 'none', cursor: 'pointer', fontSize: 15 },
  menu: { width: '100%', borderRadius: 12, padding: 8, marginBottom: 16, backgroundColor: '#f5f5f5', boxSizing: 'border-box' },
